...
class cache_sqlite:
    ...
    def __init__(self):
        ...
        # always in-memory sqlite based cache
    ...
    # cleans older than 60 seconds cache elements (those will be regenerated by update_hist_graph_scatter anyway)
